...
<a data-aos="zoom-out-left" href="" onClick={handleclick} className="  sm:inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold text-foreground text-sm font-medium shadow-gold hover:opacity-30 transition"> <IoChatbubbleEllipsesOutline />
Chat With Us</a>
    </div>
    </div>
  )
